            ...
            {spendings.length === 0 ? (
              <Card>
                <CardContent className="py-8 text-center text-muted-foreground">
                  ...
                  <p className="text-sm">Kliknij przycisk powyżej, aby dodać!</p>
                </CardContent>
              </Card>
            ) : (
                    ...
                    <CardContent className="p-4">
                      <div className="flex justify-between items-start">
                        <div className="flex-1">
                          <p className="font-semibold text-lg">${spending.amount.toFixed(2)}</p>
                          <p className="text-sm text-muted-foreground">{spending.category}</p>
                          {spending.description && (
                            <p className="text-sm mt-1">{spending.description}</p>
                          )}
                        </div>
      ...
      <nav className="fixed bottom-0 left-0 right-0 bg-card border-t shadow-lg">
        <div className="container mx-auto px-4">
          <div className="flex justify-around py-3">
            ...
            <Link href="/dashboard/spending" className="flex flex-col items-center gap-1 text-primary">
